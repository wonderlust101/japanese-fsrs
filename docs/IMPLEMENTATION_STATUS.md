...
Refreshed by code inspection on 2026-05-14 (Stage 5: drill attempts + invariance suite — leech-drill backend complete). This records current implementation evidence, not product intent. Product truth lives in [PRODUCT.md](PRODUCT.md), design truth in [DESIGN.md](DESIGN.md), database truth in [DATABASE.md](DATABASE.md), and active tasks in [KANBAN_BOARD.md](KANBAN_BOARD.md).
