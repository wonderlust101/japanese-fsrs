...
> [!success]
> Implementation status: non-AI leech remediation is complete. List/detail, resolve/reopen, drill session creation, session resume, stale detection, drill attempt recording, scheduler-invariance coverage, and frontend wiring are shipped. AI leech diagnosis remains open and is tracked separately in [[MVP (P0) Kanban Board v3]].
