...
import { describeIntegration, isIntegrationEnabled, restRpc, restSeed, restSelect, signInUser } from "./_helpers";
...
describeIntegration("insights routes — Stage 9 maturity-pipeline history", () => {
	...
	it("counts cards across FSRS states for today's live row", async () => {
		...
		await restSeed("cards", [
			{ user_id: u.userId, deck_id: u.deckId, layout_type: "vocabulary", fields_data: { word: "new", reading: "new", meaning: "new" }, state: 0, scheduled_days: 0, is_suspended: false, reps: 0, lapses: 0 },
			{ user_id: u.userId, deck_id: u.deckId, layout_type: "vocabulary", fields_data: { word: "learn1", reading: "learn1", meaning: "learn1" }, state: 1, scheduled_days: 0, is_suspended: false, reps: 1, lapses: 0 },
			{ user_id: u.userId, deck_id: u.deckId, layout_type: "vocabulary", fields_data: { word: "learn2", reading: "learn2", meaning: "learn2" }, state: 1, scheduled_days: 0, is_suspended: false, reps: 1, lapses: 0 },
			{ user_id: u.userId, deck_id: u.deckId, layout_type: "vocabulary", fields_data: { word: "review", reading: "review", meaning: "review" }, state: 2, scheduled_days: 5, is_suspended: false, reps: 3, lapses: 0 },
			{ user_id: u.userId, deck_id: u.deckId, layout_type: "vocabulary", fields_data: { word: "relearn", reading: "relearn", meaning: "relearn" }, state: 3, scheduled_days: 1, is_suspended: false, reps: 5, lapses: 1 },
			{ user_id: u.userId, deck_id: u.deckId, layout_type: "vocabulary", fields_data: { word: "mature", reading: "mature", meaning: "mature" }, state: 2, scheduled_days: 30, is_suspended: false, reps: 10, lapses: 0 },
			// Suspended card — must NOT show up in any bucket.
			{ user_id: u.userId, deck_id: u.deckId, layout_type: "vocabulary", fields_data: { word: "suspended", reading: "suspended", meaning: "suspended" }, state: 2, scheduled_days: 30, is_suspended: true, reps: 10, lapses: 0 },
		]);
