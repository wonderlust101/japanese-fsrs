...
router.get('/day-reflection/:sessionId',
  aiRateLimitMiddleware,
  aiDailyQuotaMiddleware,
  reviewsController.dayReflection,
)
...
router.post('/sessions/:sessionId/diagnose-weak-spots',
  aiRateLimitMiddleware,
  aiDailyQuotaMiddleware,
  reviewsController.diagnoseSessionWeakSpots,
)
