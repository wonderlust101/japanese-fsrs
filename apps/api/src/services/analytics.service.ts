import type { ApiAnalyticsDashboard, ApiHeatmapDay, ApiJlptGap, ApiLayoutAccuracy, ApiList, ApiMilestoneForecast } from "@fsrs-japanese/shared-types";
import {
...
export async function getDashboardData(userId: string, timeZone = "UTC"): Promise<ApiAnalyticsDashboard> {
	...
	if (error !== null)
		throw dbError("fetch dashboard data", error);
