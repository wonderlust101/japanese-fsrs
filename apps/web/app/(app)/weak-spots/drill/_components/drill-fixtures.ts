...
> = {
	...
	"mixed": () => [
		...
		sentence(1, "彼女は突然部屋を出て行った。", "She suddenly left the room.", "かのじょはとつぜんへやをでていった。", 4),
		grammar(2, { word: "にもかかわらず", meaning: "in spite of; despite", lapses: 5 }),
		vocab(3, { word: "まちまち", reading: "まちまち", meaning: "varied; mixed", lapses: 6 }),
		sentence(4, "相次ぐ事故で道路が封鎖された。", "The road was closed due to successive accidents.", "あいつぐじこでどうろがふうさされた。", 3),
	],
