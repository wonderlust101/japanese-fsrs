...
export function CardsCountLine({
  totalCount, sort, sortDir, onPickSort, onToggleSortDir, trailingNote,
...
function directionAdjectiveFor(sort: CardSortField, dir: CardSortDir): string {
  if (sort === 'recent') return dir === 'desc' ? 'newest first' : 'oldest first'
  if (sort === 'due')    return dir === 'asc'  ? 'soonest first' : 'latest first'
  // lapses
