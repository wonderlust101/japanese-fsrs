...
function rankRecommendations(rows: ReadonlyArray<ApiPremadeDeck>): ApiPremadeDeck[] {
	...
	return [...rows].sort((a, b) => {
		// Empty decks last.
		if (a.cardCount === 0 && b.cardCount > 0)
			return 1;
		if (b.cardCount === 0 && a.cardCount > 0)
			return -1;
		// JLPT-leveled ahead of level-agnostic.
		if (a.jlptLevel === null && b.jlptLevel !== null)
			return 1;
		if (b.jlptLevel === null && a.jlptLevel !== null)
			return -1;
		if (a.jlptLevel !== null && b.jlptLevel !== null) {
	...
	return (
		...
		>
			<p>
				...
				{" "}
				<span className="text-sumi-ink">skip this step</span>
				{" "}
				and browse the full catalogue from your library when you&rsquo;re ready.
			</p>
		</div>
	);
}
