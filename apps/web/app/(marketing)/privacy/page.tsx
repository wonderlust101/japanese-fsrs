  ...
  return (
    ...
    >
      <LegalSection id="collect" heading="Information we collect">
        ...
        <LegalList>
          <li>
            <strong className="font-semibold">Account information:</strong> the email address you sign
          ...
          <li>
            <strong className="font-semibold">Learning data:</strong> the cards you create or copy, your
          ...
          <li>
            <strong className="font-semibold">Content you submit:</strong> the words and text you enter
            for card, sentence, and mnemonic generation.
          </li>
          <li>
            <strong className="font-semibold">Technical and usage data:</strong> device and browser
      ...
      <LegalSection id="cookies" heading="Cookies and local storage">
        ...
        <LegalList>
          <li>
            <strong className="font-semibold">Strictly necessary cookies</strong> set by our
            authentication provider keep you signed in and protect your session.
          </li>
          <li>
            <strong className="font-semibold">Local storage</strong> on your device holds app
      ...
      <LegalSection id="bases" heading="Legal bases (EEA / UK)">
        ...
        <LegalList>
          <li><strong className="font-semibold">Performance of a contract:</strong> providing the service you signed up for.</li>
          <li><strong className="font-semibold">Legitimate interests:</strong> securing the service, preventing abuse, and improving features, balanced against your rights.</li>
          <li><strong className="font-semibold">Consent:</strong> where required, such as optional communications; you may withdraw consent at any time.</li>
          <li><strong className="font-semibold">Legal obligation:</strong> where we must process data to comply with the law.</li>
        </LegalList>
      </LegalSection>
      ...
      <LegalSection id="providers" heading="Service providers">
        ...
        <LegalList>
          <li>a <strong className="font-semibold">database and authentication provider</strong> that stores your account and learning data;</li>
          <li>a <strong className="font-semibold">language-model provider</strong> that generates card content, sentences, mnemonics, and weak-spot guidance from the words you add;</li>
          <li>a <strong className="font-semibold">caching and rate-limiting provider</strong> used for performance and abuse prevention.</li>
        </LegalList>
        <LegalP>
