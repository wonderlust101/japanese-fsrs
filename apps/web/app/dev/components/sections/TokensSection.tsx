...
const JLPT_TOKENS: ReadonlyArray<string> = [
  '--color-jlpt-n5-bg',     '--color-jlpt-n5-text',
  '--color-jlpt-n4-bg',     '--color-jlpt-n4-text',
  '--color-jlpt-n3-bg',     '--color-jlpt-n3-text',
  '--color-jlpt-n2-bg',     '--color-jlpt-n2-text',
  '--color-jlpt-n1-bg',     '--color-jlpt-n1-text',
  '--color-jlpt-beyond-bg', '--color-jlpt-beyond-text',
]

const DECK_TOKENS: ReadonlyArray<string> = [
  '--color-deck-n5-mark',     '--color-deck-n5-wash',
  '--color-deck-n4-mark',     '--color-deck-n4-wash',
  '--color-deck-n3-mark',     '--color-deck-n3-wash',
  '--color-deck-n2-mark',     '--color-deck-n2-wash',
  '--color-deck-n1-mark',     '--color-deck-n1-wash',
  '--color-deck-beyond-mark', '--color-deck-beyond-wash',
]
...
function resolveTokens(tokens: ReadonlyArray<string>): ReadonlyArray<ResolvedToken> {
  if (typeof window === 'undefined') return tokens.map(name => ({ name, value: '' }))
