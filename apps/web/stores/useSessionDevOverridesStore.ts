...
export function useSessionDevOverrides(): SessionDevOverrides {
	return useSessionDevOverridesStore(useShallow(s => ({
...
export function useSessionDevOverridesActions(): SessionDevOverridesActions {
	return useSessionDevOverridesStore(s => s.actions);
}
