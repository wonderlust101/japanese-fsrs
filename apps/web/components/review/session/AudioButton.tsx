...
export function AudioButton({
  ...
  const play = useCallback((): void => {
    ...
    if (el === null || src === null || muted) return
    el.currentTime = 0
    ...
    >
      <svg width="12" height="12" viewBox="0 0 12 12" aria-hidden="true" fill="currentColor">
        {muted ? (
          ...
          <path d="M2 4.5h2L7 2v8L4 7.5H2v-3zM8.5 4.4a2 2 0 0 1 0 3.2M10 3a3.5 3.5 0 0 1 0 6"
            stroke="currentColor" strokeWidth="0.9" strokeLinecap="round" fill="none" />
        )}
      </svg>
      {!disabled && (
        <audio
