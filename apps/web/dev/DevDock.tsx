...
import { useDevDockContext, type DevPanelRegistration } from './DevDockContext'
  ...
  return (
    <div className="px-4 py-5 text-[0.6875rem] leading-relaxed text-warm-paper-raised/55">
      ...
      <p className="mt-2">
        ...
        called <code className="font-mono text-warm-paper-raised/80">useDevStatePanel</code>{' '}
        / <code className="font-mono text-warm-paper-raised/80">useDevPanel</code> yet.
      </p>
